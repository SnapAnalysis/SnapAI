...
def StandartStructuredClassifier(TrainFilePath,TestFilePath,yLabel):
...
def AdvancedStructuredClassifier(x_train,x_test,y_train,y_test,categorical_encoding=False):
